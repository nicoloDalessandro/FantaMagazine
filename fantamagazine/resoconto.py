...
REGOLE = (
    (
        ...
        "titolo racconta quella partita. Quando scrive un modello, titolo e racconto "
        "parlano sempre della partita in apertura: se non l'hai scelta, è quella "
        "della serie da titolo.",
    ),
    (
        "Il racconto",
